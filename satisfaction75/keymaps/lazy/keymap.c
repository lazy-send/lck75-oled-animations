...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_default(
    ...
    KC_LCTL,  MO(1),  KC_LALT,                      KC_SPC,                                   KC_RALT,  KC_RCTL,  KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT
  ),
  [1] = LAYOUT_default(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______,
    KC_LGUI, _______, QK_BOOT,                   _______,                            _______, _______, _______, _______, _______, _______
  )
};
